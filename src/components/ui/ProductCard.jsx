...
function ProductCard({ type, description, price, imageUrl }) {
  return (
    <div className="relative group text-xs bg-white hover:shadow-2xl p-6 rounded-3xl w-full lg:w-52 h-auto">
      <div className="">
        {/* head */}
        <div className="">
